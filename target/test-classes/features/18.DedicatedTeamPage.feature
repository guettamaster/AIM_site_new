Feature: verifying Dedicated Team page
  ...
  Scenario: 18.001 Check that "Dedicated Team" page is opened
    ...
    Then "There are hardships in assembling the team due to the lack of local resources" tile is displayed
    Then "You need to monitor and manage all development processes with ease" tile is displayed
    Then "The requirements may change in the course of the development" tile is displayed
    Then "You want flexibility in terms of scaling up and down the team" tile is displayed
    Then "You need to concentrate on business tasks and not on the organizational ones" tile is displayed
    Then "Dedicated software development services we provide" subtitle is displayed
    Then "Business Analysis" title is displayed
    Then "UI/UX design services" title is displayed
    Then "Software engineering" title is displayed
    ...
    Then Dedicated Team page is opened
    When navigate on "Industries we work with" subtitle
    When navigate on "Ready to reach new business heights with our dedicated dev team?" title
    Then Talk to us button is displayed
    When click on Talk to us button
    Then "Let our dedicated team help with your project" subtitle is displayed
    When navigate on "Why hire our dedicated development team" subtitle
    Then "55% of all Aimprosoft clients" animation tile with highlight is displayed
    Then "productivity improvement" animation tile with highlight is displayed
    Then "45% of all our ongoing projects" animation tile with highlight is displayed
    ...
    Then "24 hours" animation tile with highlight is displayed
    Then "vast talent pool." animation tile with highlight is displayed
    Then "seamless monitoring, and management" animation tile with highlight is displayed
    Then "concentrate on high-level business activities" animation tile with highlight is displayed
    Then "hassle-free and flexible adjustment of processes" animation tile with highlight is displayed
    When navigate on "Dedicated development team setup process" subtitle
    ...
    When navigate on "Products that were developed with this model" subtitle
    Then "Web portals" active tab is displayed
    Then "Motive Retail: auto dealer integration portal" title is displayed
    ...
    Then "Virtual1: web portal for a UK’s leading telecom service provider" title is displayed
    ...
    Then "Web portals" active tab is displayed
    Then "Motive Retail: auto dealer integration portal" title is displayed
    When click on the "Web platforms" active tab
    Then "Genesys PGR: web platform for crop diversity exploration" title is displayed
    Then View project in portfolio link fourth is displayed
    When click View project in portfolio link fourth
    Then "Genesys" case study page is opened
    Given open home page
    When navigate on "Services" title in the header
    Then "Dedicated Team" link is displayed
    When click "Dedicated Team" link
    ...
    Then "MongoDE" technology in stack section is displayed
    ...
    Then "Large-scale products" tile in the Cooperation With Us section is displayed
    Then "You expect requirements changes" tile in the Cooperation With Us section is displayed
    Then "Flexible team scaling is required" tile in the Cooperation With Us section is displayed
    Then "Product maintenance" tile in the Cooperation With Us section is displayed
    ...
    Then "Workload may potentially change" tile in the Cooperation With Us section is displayed
    Then "Your project is expected to be long-term" tile in the Cooperation With Us section is displayed
    Then "You need a prompt SDLC start" tile in the Cooperation With Us section is displayed
    When click on the "Fixed price" active tab
    Then "Project specifications are defined" tile in the Cooperation With Us section is displayed
    Then "Project requirements won’t change" tile in the Cooperation With Us section is displayed
    Then "Small-scale and short-term projects" tile in the Cooperation With Us section is displayed
    Then "You want to build an MVP first" tile in the Cooperation With Us section is displayed
    When click on the "Hybrid approach" active tab
    Then "Projects with a great scope of work" tile in the Cooperation With Us section is displayed
    Then "Feature set may possibly change" tile in the Cooperation With Us section is displayed
    Then "Lack of clearly defined requirements" tile in the Cooperation With Us section is displayed
    Then "Medium or large-scale projects" tile in the Cooperation With Us section is displayed
    When navigate on "Key reasons to choose Aimprosoft" subtitle
    Then "Impressive talent pool" title is displayed
    Then "Extensive experience" title is displayed
    Then "Strong track record" title is displayed
    Then "Multi-faceted portfolio" title is displayed
    Then "Reliability" title is displayed
    ...
    Then "What are the different dedicated team models?" item is displayed
    Then "the difference between outstaffing and the dedicated team cooperation model?" item is displayed
    Then "How do I choose a dedicated development team?" item is displayed
    When navigate on "Related services and expertise" subtitle
    Then "IT Outsourcing Company" title is displayed
    ...
    Then "Offshore Software Development Company" title is displayed
    ...
    Then "Offshore Software Development Company" title is displayed
    When click right arrow fourth in the Clients carousel
    Then "IT Staff Augmentation Company" title is displayed
