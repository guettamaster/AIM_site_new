Feature: verifying Business Analysis page

  Scenario: 19.001 Check that "Business Analysis" page is opened
    ...
    Then "Let our business analysts help with your project" subtitle is displayed
    When navigate on "Business Analysis Services" general title
    ...
    Then "You plan to assess market trends and user needs before the development" tile is displayed
    Then "There is a necessity to conduct the discovery phase" tile is displayed
    Then "You want to mitigate possible risks by defining clear project requirements" tile is displayed
    Then "Services we provide" subtitle is displayed
    Then "Software requirements creation" title is displayed
    Then "Industry and competitive analysis" title is displayed
    Then "Validation of technical solution" title is displayed
    Then "Software optimization" title is displayed
    When navigate on right arrow in the carousel
    When click right arrow in the carousel
    Then "Resource estimation" title is displayed
    ...
    Then Business Analysis page is opened
    When navigate on "Industries we work with" subtitle
    When navigate on "Need assistance with the business analysis stage?" title
    Then Talk to us button is displayed
    When click on Talk to us button
    Then "Let our business analysts help with your project" subtitle is displayed
    When navigate on "Business analysis process with Aimprosoft" subtitle
    Then "Initial requirements elicitation" title is displayed
    Then "Research & analysis" title is displayed
    Then "Setting the objectives" title is displayed
    Then "Documenting the requirements" title is displayed
    Then "Project scope statement creation" title is displayed
    When navigate on "Business analysis services we provided" subtitle
    Then "Web-based solutions" active tab is displayed
    Then "Aimchat web: a corporate messenger for businesses of all sizes" title is displayed
    ...
    Then "Sector Edge" case study page is opened
    Given open home page
    When navigate on "Services" title in the header
    Then "Business Analysis" link is displayed
    When click "Business Analysis" link
    ...
    Then "Aimchat mobile app: a corporate messenger for businesses of all sizes" title is displayed
    When click on the "Modules & extensions" active tab
    Then "Cloud Backup And Migration For SAP® Commerce" title is displayed
    When click right arrow first in the Clients carousel
    Then "App4Comparison" title is displayed
    When navigate on "Top 3 reasons to engage business analysts in your project" subtitle
    Then "Cost reduction" animation tile is displayed
    Then "Everyone is on the same page" animation tile is displayed
    Then "Higher chances of project success" animation tile is displayed
